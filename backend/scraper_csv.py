...
Diferenças em relação ao scraper.py original:
  - Foco nos anos 2020–2026 (arquivos mais pesados e relevantes)
...
Uso:
  python scraper_csv.py               # baixa/atualiza 2020–2026
  python scraper_csv.py --anos 2025 2026
...
# Apenas 2020–2026 nesta versão CSV
ARQUIVOS = {
...
def sincronizar(anos: list[int] = None, forcar: bool = False, limpar_csv: bool = False):
    ...
    for ano in anos_alvo:
        ...
        if not url:
            print(f"⚠️  Ano {ano} sem URL configurada (somente 2020–2026 neste modo).")
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument("--anos", nargs="+", type=int, help="Anos a processar (default: 2020-2026)")
